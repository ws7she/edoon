...
.trigger('focusin');
        ...
        methods: {
            ...
            remote: function (value, element, param) {
                ...
                this.settings.messages[element.name].remote = $(element).attr("aria-message") || previous.message;
                param = typeof param === 'string' && { url: param } || param;
                if (previous.old === value) {
                    //失去焦点时，如果值没有改变过，就不发ajax，直接显示上次校验的结果
                ...
                $.ajax($.extend(true, {
                    ...
                    success: function (response) {
                        ...
                        validator.settings.messages[element.name].remote = $(element).attr("aria-message") || previous.originalMessage;
                        if (valid) {
